  ...
  "inline-flex items-center justify-center gap-2 whitespace-nowrap rounded-md text-sm font-medium ring-offset-background transition-gentle focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring focus-visible:ring-offset-2 disabled:pointer-events-none disabled:opacity-50 [&_svg]:pointer-events-none [&_svg]:size-4 [&_svg]:shrink-0",
  {
    variants: {
      variant: {
        ...
        hero: "bg-gradient-warm text-foreground hover:shadow-warm transform hover:scale-105 transition-bounce shadow-soft",
        cozy: "bg-cappuccino text-cappuccino-deep hover:bg-cappuccino/80 shadow-soft",
        gentle: "bg-gentle-breeze text-gentle-breeze-deep hover:bg-gentle-breeze/80 shadow-soft",
        warm: "bg-peachy text-peachy-deep hover:bg-peachy/80 shadow-warm",
      },
      size: {
